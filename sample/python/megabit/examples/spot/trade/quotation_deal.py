...
def get_quotation_deal(url, method: str, headers=None, payload=None):
    """
    获取K线数据
    :param url: 请求的URL
...
if __name__ == '__main__':
    ...
    api_url = base_api_url + "/spot/v1/p/quotation/deal"
    payload = {
        "symbol": "BTC_USDT",
        "num": 30,
    }
    resp_json = get_quotation_deal(api_url, "GET", None, payload)
